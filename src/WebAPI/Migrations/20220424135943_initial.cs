        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailablSeats = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderersId = table.Column<int>(type: "int", nullable: false),
                    OrdersId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderOrderer", x => new { x.OrderersId, x.OrdersId });
                    table.ForeignKey(
                        name: "FK_OrderOrderer_Orderers_OrderersId",
                        column: x => x.OrderersId,
                        principalTable: "Orderers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderOrderer_Orders_OrdersId",
                        column: x => x.OrdersId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderPassenger", x => new { x.OrdersId, x.PassengersId });
                    table.ForeignKey(
                        name: "FK_OrderPassenger_Orders_OrdersId",
                        column: x => x.OrdersId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderPassenger_Passengers_PassengersId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TripId = table.Column<int>(type: "int", nullable: false),
                    PitStopId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TripPitStops", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TripPitStops_PitStops_PitStopId",
                        column: x => x.PitStopId,
                        principalTable: "PitStops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TripPitStops_Trips_TripId",
                        column: x => x.TripId,
                        principalTable: "Trips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderOrderer_OrdersId",
                table: "OrderOrderer",
                column: "OrdersId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderPassenger_PassengersId",
                table: "OrderPassenger",
                column: "PassengersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TripPitStops_PitStopId",
                table: "TripPitStops",
                column: "PitStopId");

            migrationBuilder.CreateIndex(
                name: "IX_TripPitStops_TripId",
                table: "TripPitStops",
                column: "TripId");
